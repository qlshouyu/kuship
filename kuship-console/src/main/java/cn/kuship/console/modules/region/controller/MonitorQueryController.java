...
public class MonitorQueryController {
    ...
    /** GET /console/monitor/query?query=...&region_name=... */
    @GetMapping("/console/monitor/query")
    @SkipResponseWrapper
    public Object query(@RequestParam(value = "query", required = false, defaultValue = "") String query,
