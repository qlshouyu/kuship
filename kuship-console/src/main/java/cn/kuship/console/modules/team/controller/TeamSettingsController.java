...
public class TeamSettingsController {
    ...
    public ApiResult pemTransfer(@PathVariable("team_name") String teamName, @RequestBody Map<String, Object> body) {
    ...
    public ApiResult modifyName(@PathVariable("team_name") String teamName, @RequestBody Map<String, Object> body) {
        Tenants team = teamContextResolver.requireTeam(teamName);
